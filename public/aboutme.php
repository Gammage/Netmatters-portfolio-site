            ...
            <div class="row">
                ...
                <div class="container-fluid name_card_content">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 bio_p">
                        ...
                        <p class="card_desc">Below are languages I have experience with. Whilst I do have a particular interest with the languages/services listed, Im open to any opportunites to learn and further my career. To that end, please do not hesitate to <a href="../public/index.html#contact">contact me</a></p>
                    </div>
                    </div>
                </div>
                </div>
