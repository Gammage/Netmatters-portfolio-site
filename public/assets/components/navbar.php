<div id="navbar">
        <nav>
            ...
            <ul>
                <li><a class="nav_btn" href="./aboutme.php">About me</a></li>
                <li><a class="nav_btn" href="./index.php#content_index">My portfolio</a></li>
                <li><a class="nav_btn" href="./coding_examples.php">Coding Examples</a></li>
                <li><a class="nav_btn" href="./scs_scheme.php">SCS Scheme</a></li>
            </ul>
            <ul>
                <li class="li_contact"><a class="nav_btn_contact" href="./index.php#contact">Contact me</a></li>
            </ul>
            <div class="container">
